...
if (!isset($pdo)) {
    die("PDO variable missing from db.php");
}
...
try {
    $sql = "ALTER TABLE stories ADD COLUMN image_path VARCHAR(255) DEFAULT NULL";
    $pdo->exec($sql);
